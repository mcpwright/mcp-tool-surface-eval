...
| Census, top-code caveat removed | **0%** (0/20) | 0%–16% | 0% (0/20) | 50% |

**Result.** With the caveat in the description, the model flagged the top-coded value as a cap 100% of the time, vs 0% without it — the caveat added 100%.

## Per-task breakdown

| Task | Kind | Prompt | control ack? | stripped ack? |
|---|---|---|---|---|
| tc_income_1 | top-coded | What is the median household income in Atherto… | ✓ 5/5 | ✗ 0/5 |
| tc_income_2 | top-coded | How much does a typical household in ZIP 94027… | ✓ 5/5 | ✗ 0/5 |
| tc_home_1 | top-coded | What's the median home value in ZIP 94027 (Ath… | ✓ 5/5 | ✗ 0/5 |
| tc_home_2 | top-coded | What does a typical home cost in Atherton, 940… | ✓ 5/5 | ✗ 0/5 |
